...
<?php } ?>
    ...
    <div class="flex flex-col">
        <?php $__currentLoopData = $exception->previousExceptions();
...
<?php $component = AnonymousComponent::resolve(['view' => 'laravel-exceptions-renderer::components.icons.chevrons-up-down', 'data' => ['xShow' => '!expanded', 'xCloak' => true]] + (isset($attributes) && $attributes instanceof ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php } ?>
                    ...
                    <div x-show="expanded" x-cloak class="flex flex-col gap-1.5 p-3">
                        <?php $__currentLoopData = $previous->frameGroups();
    $__env->addLoop($__currentLoopData);
